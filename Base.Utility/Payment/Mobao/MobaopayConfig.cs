...
namespace Base.Utility
{
    ...
    public class MobaopayConfig
    {
        ...
        static MobaopayConfig()
        {
            ...
            //摩宝支付网关地址
            //商户用地址-测试
            mobaopay_gateway = "https://182.148.123.7/cgi-bin/netpayment/pay_gate.cgi";// "https://trade.mobaopay.uat/cgi-bin/netpayment/pay_gate.cgi";
            //商户用地址-正式
            //mobaopay_gateway = "https://trade.mobaopay.com/cgi-bin/netpayment/pay_gate.cgi";

            //商户接受支付通知地址(商户自己系统的地址)
            merchant_notify_url = "http://192.168.31.234/MBPExampleNet/Callback.aspx";
